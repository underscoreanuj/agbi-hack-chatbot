  ...
  return new Promise((resolve) => {
    resolve(html`
      ...
      <div class="card-text">
        ...
        <p class="text-muted small">
          <i class="fa fa-info-circle"></i> This screen uses an NLP driven model to find symptoms in the given text.
          Evidence found in text will be marked as initial which is crucial for the AI model to make a good deduction. 
